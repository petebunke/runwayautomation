                                ...
                                <div className="row g-2">
                                  <div className="col-6">
                                    <div className="text-center p-3 border rounded bg-white">
                                      <div className="h5 mb-1 text-success d-flex align-items-center justify-content-center">
                                  ...
                                  <div className="col-6">
                                    <div className="text-center p-3 border rounded bg-white">
                                      <div className="h5 mb-1 text-primary d-flex align-items-center justify-content-center">
                                        <span>
