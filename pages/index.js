                          ...
                          <div className="col-6">
                            <label className="form-label fw-bold">
                              ...
                              <i 
                                ...
                                title="<strong>Aspect Ratio Options:</strong><br/>• <strong>16:9 (Landscape)</strong> - YouTube, TV, desktop<br/>• <strong>9:16 (Portrait)</strong> - TikTok, Instagram Stories, mobile<br/>• <strong>1:1 (Square)</strong> - Instagram posts, profile pics<br/>• <strong>4:3 (Standard)</strong> - Classic TV, monitors<br/>• <strong>3:4 (Portrait Standard)</strong> - Print, documents<br/>• <strong>21:9 (Cinematic)</strong> - Ultrawide movies"
                              ></i>
                            </label>
                            <select
                              className="form-select"
