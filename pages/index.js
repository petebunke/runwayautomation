                ...
                <div className="row g-4">
                  <div className="col-lg-6">
                    <div className="card shadow-lg border-0" style={{ borderRadius: '20px', overflow: 'hidden' }}>
                      ...
                      {/* Card content with tighter padding for hanging circle */}
                      <div className="card-body p-4" style={{ paddingTop: '25px !important' }}>
                        <div className="mb-4">
              ...
              <div className="col-lg-10">
                <div className="card shadow-lg border-0" style={{ borderRadius: '20px', overflow: 'hidden' }}>
                  ...
                  >
                    ...
                    {/* Centered header text inside blue section - using absolute positioning for perfect centering */}
                    <div 
                        ...
                        <button
                          ...
                          onMouseDown={(e) => {
                            if (!e.target.disabled) {
                              ...
                              e.target.style.borderColor = 'rgba(34, 197, 94, 1)';
                            }
                          }}
                          onMouseUp={(e) => {
                            if (!e.target.disabled) {
            ...
            <div className="row justify-content-center">
              <div className="col-lg-11">
                <div className="card shadow-lg border-0" style={{ borderRadius: '20px', overflow: 'hidden' }}>
                  ...
                  >
                    {/* Icon circle hanging over the blue section - same size as others */}
                    <div 
              ...
              <small>Vibe coded by <a href="https://petebunke.com" target="_blank" rel="noopener noreferrer" className="text-white-50 fw-bold text-decoration-none">Pete Bunke</a>. All rights reserved.<br /><a href="mailto:petebunke@gmail.com?subject=Runway%20Automation%20User%20Feedback" className="text-white-50 text-decoration-none"><strong>Got user feedback?</strong> Hit me up!</a></small>
                  ...
                  <div className="col-lg-6">
                    <div className="card shadow-lg border-0" style={{ borderRadius: '20px', overflow: 'hidden' }}>
                      {/* Blue header with hanging circle */}
                      <div 
                        className="bg-primary position-relative d-flex align