...
export default function RunwayAutomationApp() {
  ...
  return (
    <>
      ...
      <div className="vh-100 d-flex flex-column" style={{ background: 'black', fontFamily: 'Normal, Inter, system-ui, sans-serif' }}>
        <div className="flex-grow-1 overflow-auto">
          <div className="container-fluid py-4" style={{ paddingRight: '0', paddingLeft: '0' }}>
            ...
            {activeTab === 'generation' && (
              <div className="row justify-content-center flex-grow-1" style={{ margin: '0' }}>
                <div className="col-lg-10 d-flex flex-column" style={{ maxWidth: '1200px', paddingLeft: '12px', paddingRight: '12px' }}>
                  <div className="card shadow-lg border-0 flex-grow-1 d-flex flex-column" style={{ borderRadius: '8px', overflow: 'hidden' }}>
                    ...
                    <div className="card-body p-4 d-flex flex-column flex-grow-1" style={{ paddingTop: '30px !important' }}>
                      <div className="mb-4"></div>
