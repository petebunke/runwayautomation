              ...
              <div className="col-lg-10">
                <div className="card shadow-lg border-0" style={{ borderRadius: '8px', overflow: 'hidden' }}>
                  ...
                  <div className="card-body p-4" style={{ paddingTop: '30px !important' }}>
                    ...
                    </div>-absolute rounded-circle d-flex align-items-center justify-content-center"
                          style={{ 
                            width: '80px', 
                            height: '80px',
                            left: '20px',
                  ...
                  <div className="col-lg-6">
                    <div className="card shadow-lg border-0" style={{ borderRadius: '8px', overflow: 'hidden' }}>
                      ...
                      >
                        <div 
                          className="positionimport React, { useState, useEffect, useRef } from 'react';
        ...
        <div>
          ...
          {organizationInfo && (
            <div className="row g-2 mb-3">
              ...
              <div className="col-6">
                <div className="text-center p-2 border rounded">
                  <div className="h6 mb-1 text-danger">~500</div>
                  <small className="text-muted">Credits Needed</small>
                </div>
              </div>
            </div>
    ...
    while (pollCount < maxPolls) {
      try {
        ...
        if (task.status === 'SUCCEEDED') {
          ...
          // Refresh credit balance after upscaling
          setTimeout(() => {
            checkOrganizationCredits();
          }, 1000);
